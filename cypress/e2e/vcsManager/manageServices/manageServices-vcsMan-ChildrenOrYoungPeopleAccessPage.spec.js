describe.skip('VCS Manager - manage services - can children or young people access page', () => {
    beforeEach(() => {
        cy.visit('/')
    ...
    it('validate page content and back link', () => {
        ...
        const expectedPreviousPageHeading = 'Elop Mentoring';
    ...
    it('Select No radio button and continue to next page', () => {
        const expectedNextPageHeading = 'Elop Mentoring';
