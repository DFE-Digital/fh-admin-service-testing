describe('VCS Admin - Add locations - What is the address page', () => {
    beforeEach(() => {
        cy.visit('/')
    ...
    it('validate page content and back link', () => {
        ...
        const previousPageHeading = 'Elop Mentoring Locations';
    ...
    it('enter valid address and continue to next page', () => {
        ...
        const nextPageHeading = 'Is there anything else people need to know about this location?';
